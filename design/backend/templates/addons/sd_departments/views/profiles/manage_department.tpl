...
<form action="{""|fn_url}" method="post" id="departments_form" name="departments_form" enctype="multipart/form-data">
    ...
    {include "common/pagination.tpl" save_current_page=true save_current_url=true div_id="pagination_contents_banners"}
    ...
    div_id="pagination_contents_banners"}
...
{capture name="sidebar"}
    {hook name="departments:manage_sidebar"}
        ...
        dispatch="profiles.manage_department" 
        view_type="departments"}
        {include "addons/sd_departments/views/profiles/components/department_search_form.tpl" 
        dispatch="profiles.manage_department"}
    {/hook}
{/capture}
